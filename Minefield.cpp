...
Minefield::Minefield(const sf::Vector2u &windowSize) {
  if (this->txt_tile_unclicked.loadFromFile("assets/tile_unclicked.png") ==
      false) {
  ...
  this->scale = sf::Vector2f(
      (double)this->scaled_size.x / (double)this->txt_tile_clicked.getSize().x,
